...
`.trim()
        ...
        if (/fishop|tokoikan/i.test(command)) {
            ...
            case 'buy':
                switch (_type) {
                    case 'paus':
                            if (global.db.data.users[m.sender].uang >= Bpaus * count) {
                                global.db.data.users[m.sender].uang -= Bpaus * count
                        ...
                        break
                    case 'ikan':
                            if (global.db.data.users[m.sender].uang >= Bikan * count) {
                                global.db.data.users[m.sender].ikan += count * 1
                                global.db.data.users[m.sender].uang -= Bikan * count
                        ...
                        break
                    case 'cumi':
                            if (global.db.data.users[m.sender].uang >= Bcumi * count) {
                                global.db.data.users[m.sender].cumi += count * 1
                                global.db.data.users[m.sender].uang -= Bcumi * count
                        ...
                        break
                    case 'kepiting':
                            if (global.db.data.users[m.sender].uang >= Bkepiting * count) {
                                global.db.data.users[m.sender].kepiting += count * 1
                                global.db.data.users[m.sender].uang -= Bkepiting * count
                        ...
                        break
                    case 'udang':
                            if (global.db.data.users[m.sender].uang >= Budang * count) {
                                    global.db.data.users[m.sender].udang += count * 1
                                global.db.data.users[m.sender].uang -= Budang * count
                        ...
                        break
                    case 'dory':
                            if (global.db.data.users[m.sender].uang >= Bdory * count) {
                                global.db.data.users[m.sender].dory += count * 1
                                global.db.data.users[m.sender].uang -= Bdory * count
                        ...
                        break
                 case 'lobster':
                            if (global.db.data.users[m.sender].uang >= Blobster * count) {
                                global.db.data.users[m.sender].lobsyer += count * 1
                                global.db.data.users[m.sender].uang -= Blobster * count
                        ...
                        break     
                    case 'buntal':
                            if (global.db.data.users[m.sender].uang >= Bbuntal * count) {
                                global.db.data.users[m.sender].buntal += count * 1
                                global.db.data.users[m.sender].uang -= Bbuntal * count
                        ...
                        break                   
                        case 'orca':
                            if (global.db.data.users[m.sender].uang >= Borca * count) {
                                global.db.data.users[m.sender].uang -= Borca * count
                        ...
                        break
                    case 'gurita':
                            if (global.db.data.users[m.sender].uang >= Bgurita * count) {
                                global.db.data.users[m.sender].gurita += count * 1
                                global.db.data.users[m.sender].uang -= Bgurita * count
                ...
                switch (_type) {
                    case 'orca':
                        if (global.db.data.users[m.sender].orca >= count * 1) {
                            global.db.data.users[m.sender].uang += Sorca * count
                            global.db.data.users[m.sender].orca -= count * 1
                    ...
                    case 'ikan':
                        if (global.db.data.users[m.sender].ikan >= count * 1) {
                            global.db.data.users[m.sender].uang += Sikan * count
                            global.db.data.users[m.sender].ikan -= count * 1
                    ...
                    case 'paus':
                        if (global.db.data.users[m.sender].paus >= count * 1) {
                            global.db.data.users[m.sender].uang += Spaus * count
                            global.db.data.users[m.sender].paus -= count * 1
                    ...
                    case 'gurita':
                        if (global.db.data.users[m.sender].gurita >= count * 1) {
                            global.db.data.users[m.sender].uang += Sgurita * count
                            global.db.data.users[m.sender].gurita -= count * 1
                    ...
                    case 'udang':
                        if (global.db.data.users[m.sender].udang >= count * 1) {
                            global.db.data.users[m.sender].uang += Sudang * count
                            global.db.data.users[m.sender].udang -= count * 1
                     ...
                     case 'buntal':
                        if (global.db.data.users[m.sender].buntal >= count * 1) {
                            global.db.data.users[m.sender].buntal -= count * 1
                            global.db.data.users[m.sender].uang += Sbuntal * count
                    ...
                    case 'lobster':
                        if (global.db.data.users[m.sender].lobster >= count * 1) {
                            ...
                            global.db.data.users[m.sender].uang += Slobster * count
                    ...
                    case 'dory':
                        if (global.db.data.users[m.sender].dory >= count * 1) {
                            global.db.data.users[m.sender].dory -= count * 1
                            global.db.data.users[m.sender].uang += Sdory * count
                    ...
                    case 'cumi':
                        if (global.db.data.users[m.sender].cumi >= count * 1) {
                            global.db.data.users[m.sender].cumi -= count * 1
                            global.db.data.users[m.sender].uang += Scumi * count
                    ...
                    case 'kepiting':
                        if (global.db.data.users[m.sender].kepiting >= count * 1) {
                            global.db.data.users[m.sender].kepiting -= count * 1
                            global.db.data.users[m.sender].uang += Skepiting * count
                    ...
                    case 'hiu':
                        if (global.db.data.users[m.sender].hiu >= count * 1) {
                            ...
                            global.db.data.users[m.sender].uang += Shiu * count
                    ...
                    case 'lumba':
                        if (global.db.data.users[m.sender].lumba >= count * 1) {
                            ...
                            global.db.data.users[m.sender].uang += Slumba * count
