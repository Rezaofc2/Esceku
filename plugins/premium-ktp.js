...
let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    if (!args[0]) return conn.reply(m.chat,  `.ktp 6288980870067|JAWA TIMUR|ponorogo|Reza|18/07/2007|laki-laki|ponorogo|01/05|tanjunggunung|badegan|islam|lanjang|turu|indonesia|seumur hidup`, m)
