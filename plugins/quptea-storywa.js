let handler = async (m, { conn, usedPrefix, command }) => {
			...
			await conn.sendMessage(m.chat, { video: { url: dir[Math.floor(Math.random() * dir.length)] }, caption: 'NIH KAK' }, { quoted: m })
	}

handler.help = ['storywa']
handler.tags = ['quotes']
handler.command = /^(stor(i|y)wa|wastor(i|y))$/i
handler.limit = true
