...
let pp = pickRandom(hwaifu)
        ...
        if (/use|pakai/i.test(command)) {
            try {
                 ...
                 if (args[0] === 'potion') {
                    if (global.db.data.users[m.sender].healt < 100) {
                        if (global.db.data.users[m.sender].potion >= count * 1) {
                            ...
                            conn.reply(m.chat, msgsucces, m, { contextInfo: { externalAdReply: {title: null, body: wm, sourceUrl: yt, thumbnailUrl: pp }}})
                        } else conn.reply(m.chat, msgkurang, m, { contextInfo: { externalAdReply: {title: null, body: wm, sourceUrl: yt, thumbnailUrl: pp }}})
                    } else conn.reply(m.chat, msgpenuh, m, { contextInfo: { externalAdReply: {title: null, body: wm, sourceUrl: yt, thumbnailUrl: pp }}})
                ...
                console.log(e)
                conn.reply(m.chat, msgerror, m, { contextInfo: { externalAdReply: {title: null, body: wm, sourceUrl: yt, thumbnailUrl: pp }}})
                if (DevMode) {
