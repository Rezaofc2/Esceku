...
let handler = async (m, { conn }) => {
 await conn.sendMessage(m.chat, { react: { text: `⏱️`, key: m.key }});
  conn.sendFile(m.chat, pickRandom(da), 'mesum.jpg', "*mesum*", m, false, { contextInfo: { mentionedJid: conn.parseMention("m") }})
}
handler.help = ['animehentai']
handler.tags = ['nsfw']
handler.command = ['animehentai'] 
