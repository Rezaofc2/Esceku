...
`.trim();
            if (global.db.data.users[m.sender].common >= 1) {
              ...
              global.db.data.users[m.sender].uang += cm * 1;
...
`.trim();
            if (global.db.data.users[m.sender].common >= 10) {
              ...
              global.db.data.users[m.sender].uang += cm1 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].common >= 100) {
              ...
              global.db.data.users[m.sender].uang += cm2 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].common >= 1000) {
              ...
              global.db.data.users[m.sender].uang += cm3 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 1) {
              ...
              global.db.data.users[m.sender].uang += um * 1;
...
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 10) {
              ...
              global.db.data.users[m.sender].uang += um1 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 100) {
              ...
              global.db.data.users[m.sender].uang += um2 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].uncommon >= 1000) {
              ...
              global.db.data.users[m.sender].uang += um3 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].mythic >= 1) {
              ...
              global.db.data.users[m.sender].uang += mm * 1;
...
`.trim();
            if (global.db.data.users[m.sender].mythic >= 10) {
              ...
              global.db.data.users[m.sender].uang += mm1 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].mythic >= 100) {
              ...
              global.db.data.users[m.sender].uang += mm2 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].mythic >= 1000) {
              ...
              global.db.data.users[m.sender].uang += mm3 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].legendary >= 1) {
              ...
              global.db.data.users[m.sender].uang += lm * 1;
...
`.trim();
            if (global.db.data.users[m.sender].legendary >= 10) {
              ...
              global.db.data.users[m.sender].uang += lm1 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].legendary >= 100) {
              ...
              global.db.data.users[m.sender].uang += lm2 * 1;
...
`.trim();
            if (global.db.data.users[m.sender].legendary >= 1000) {
              ...
              global.db.data.users[m.sender].uang += lm3 * 1;
      ...
      case 'pet':
            ...
            let _pet = `${pickRandom(['kucing', 'rubah', 'anjing', 'kuda','centaur','griffin','kyubi','phonix','naga','serigala'])}`.trim()
