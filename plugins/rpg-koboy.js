...
Reply pesan ini Ketik *kanan* untuk bergerak ke kanan.

Reply pesan ini Ketik *kiri* untuk bergerak ke kiri.`;
...
handler.before = async (m, {
    ...
    if (m.quoted || m.quoted.id == key) {
        ...
        if (playerPosition === criminalPosition) {
            ...
            delete conn.koboy[m.chat];
            return conn.reply(m.chat, `😔 Kamu kalah! ${m.name} sudah mencapai batas maksimum gerakan.`, m, {
                mentions: [sender]
            });
        }
