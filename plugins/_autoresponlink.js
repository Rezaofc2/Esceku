...
let pp = await conn
    ...
    let teks = `HARGA SEWA BOT
Rp 15k perbulan

Jika mau sewa silahkan chat owner`
    this.reply(m.chat, Styles(teks), m, { contextInfo: { mentionedJid: conn.parseMention(teks),forwardingScore: 256,
