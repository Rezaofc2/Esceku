...
let handler = async (m, {
    ...
    try {
        ...
        conn.sendFile(m.chat, audio, '', null, m, true, { type: "audioMessage", ptt: true, waveform: [10,20,30,40,50,12,13,16,91,7] }, { quoted: m })
    } catch (err) {
        m.reply('Error!\n\n' + err)
    }
}
...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    ...
    conn.sendFile(m.chat, buffer, '', null, m, true, { type: "audioMessage", ptt: true, waveform: [10,20,30,40,50,12,13,16,91,7] }, { quoted: m })
  } catch (e) {
    throw eror;
  }
};
