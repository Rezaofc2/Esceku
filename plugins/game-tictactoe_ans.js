...
`.trim()
        ...
        if (room.x !== room.o)
            await this.reply(room.x, str, m, { contextInfo: { mentionedJid: conn.parseMention(str),forwardingScore: 256,
      isForwarded: true, externalAdReply: { title: null, body: wm, sourceUrl: yt, thumbnailUrl: pickRandom(hwaifu) }}})
        await this.reply(room.o, str, m, { contextInfo: { mentionedJid: conn.parseMention(str),forwardingScore: 256,
      isForwarded: true, externalAdReply: { title: null, body: wm, sourceUrl: yt, thumbnailUrl: pickRandom(hwaifu) }}})
        if (isTie || isWin) {
