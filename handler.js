        ...
        try {
            // TODO: use loop to insert data instead of this
             ...
             if (!isNumber(user.ayam)) user.ayam = 0
                    ...
                    if (!isNumber(user.lastgemsclaim)) user.lastgemsclaim = 0
                    ...
                    if (!user.seller) user.sellerTime = 1
...
silahkan hubungi owner bot untuk membeli akses *PREMIUM* seharga *15k/bulan*
...
global.dfail = (type, m, conn) => {
    let msg = {
 rowner: 'Perintah ini hanya untuk *R-OWNER*',
